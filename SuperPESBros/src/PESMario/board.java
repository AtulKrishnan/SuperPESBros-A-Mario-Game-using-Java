...
public class board extends JPanel implements ActionListener {
    ...
    public board() {
        ...
        ImageIcon i = new ImageIcon("D:/ATUL/PES/Sem6/OOAD/JavaPrograms/Eclipse/SuperPESBros/media/home.png");                  //Image for menu
        menuBg = i.getImage();
        i = new ImageIcon("D:/ATUL/PES/Sem6/OOAD/JavaPrograms/Eclipse/SuperPESBros/media/FINAL_FINAL_MAP.png");  //Image for background
        background = i.getImage();                                                           //Give the background the image
        i = new ImageIcon("D:/ATUL/PES/Sem6/OOAD/JavaPrograms/Eclipse/SuperPESBros/media/select_char.png");                  //Image for menu
        characterBg = i.getImage();
        i = new ImageIcon("D:/ATUL/PES/Sem6/OOAD/JavaPrograms/Eclipse/SuperPESBros/media/died.png");                  //Image for menu
        gameOver = i.getImage();
        i = new ImageIcon("D:/ATUL/PES/Sem6/OOAD/JavaPrograms/Eclipse/SuperPESBros/media/win.png");                  //Image for menu
        gameWon = i.getImage();
